                            ...
                            <div class="navbar-nav mx-auto border-top">
                                ...
                                <div class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                        <a href="{{ route('category.show', 'kesehatan') }}" class="dropdown-item">Kesehatan</a>
                                        <a href="{{ route('category.show', 'games') }}" class="dropdown-item">Games</a>
                                        <a href="{{ route('category.show', 'wisata') }}" class="dropdown-item">Wisata</a>
